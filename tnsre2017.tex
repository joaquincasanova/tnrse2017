...
\begin{table*}[h!]
  ...
  \begin{tabular}{c||c|c|c|c}
    ...
    \hline
    \hline
    Auditory & 5.387, 0.227 & 5.076, 0.134 & 35.270, 2.677 & 34.167, 2.373 \\
    \hline
    Faces &  1.905, 0.023 & 1.895, 0.018 & 47.299, 2.249 & 42.576, 1.3027 \\
    \hline
  \end{tabular}
...
The authors would like to thank DARPA and Oceanit.
