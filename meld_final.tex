...
\begin{abstract}
  ...
  Finally, live rat tests were conducted, using the fluxgate circuit and inversion algorithm. These experiments are described in detail and results are presented.
...
\begin{figure}[h!]
\centering
\includegraphics[width=3.5in]{finalplots/aud1}
...
\begin{figure}[h!]
\centering
\includegraphics[width=3.5in]{finalplots/faces1}
...
\begin{figure}[h!]
\centering
\includegraphics[width=3.5in]{finalplots/tf1_0_subject_aud_pca_all_True_rand_True_cnn_True_rnn_False_locate_1_treat_None_train_1000}
...
\begin{figure}[h!]
\centering
\includegraphics[width=3.5in]{finalplots/tf1_0_subject_aud_pca_all_True_rand_True_cnn_True_rnn_False_locate_1_treat_None}
...
\begin{figure}[h!]
\centering
\includegraphics[width=3.5in]{finalplots/aud100}
...
\begin{figure}[h!]
\centering
\includegraphics[width=3.5in]{finalplots/faces100}
...
Additionally, we tried narrowing the training, so it was limited to specific treatments. That is, train a specific network just using the left/auditory stimulus, for example ...
